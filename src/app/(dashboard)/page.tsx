...
import ContactAdminMobile from "./hubungiAdminMobile";
...
export default function Home() {
  ...
  return (
    <div className={styles.mainContent}>
      <div className={`rounded-xl shadow-md flex justify-around bg-white py-3 space-x-4 mb-8 ${styles.mobileSummaryMenu}`}>
        {/* Panduan */}
        <Link href={"/guide"} className="flex flex-col items-center space-y-2 group">
          <div className="p-4 bg-blue-100 rounded-full transition-transform group-hover:scale-110">
            <FaBook className="fill-blue-600 w-6 h-6" />
          </div>
          <small className="text-gray-600 group-hover:text-blue-800 font-medium">Panduan</small>
        </Link>
        ...
        {/* Rangkuman */}
        <button type="button" className="flex flex-col items-center space-y-2 group" onClick={toggleSummaryModal}>
          <div className="p-4 bg-blue-100 rounded-full transition-transform group-hover:scale-110">
            <FaClipboard className="fill-blue-600 w-6 h-6" />
          </div>
          <small className="text-gray-600 group-hover:text-blue-800 font-medium">Rangkuman</small>
        </button>
      </div>

      <div className={styles.evaluationCardContainer}>
        <h4 className="text-black text-center md:text-left">Lembar Kerja Evaluasi Tersedia</h4>
        ...
        <h4 className="text-black text-center md:text-left">Lembar Kerja Evaluasi Selesai</h4>
      ...
      {isSummaryModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-11/12 max-w-md max-h-[70%] overflow-y-auto p-0">
            ...
            <div className={styles.summaryCardMobile}>
              <div className={styles.title}>
                <h2 className="font-bold text-xl flex justify-center">
                  {inProgressSheets.length !== 0 ?
                    <span className="mt-[8px] text-center font-bold px-8 py-2 bg-green-600 rounded-full shadow-md text-white w-fit">{inProgressSheets[0]?.title ?? "Loading .."}</span>
              ...
              {inProgressSheets.length !== 0 ? (
                ...
                <div className={inProgressSheets.length === 0 ? "hidden" : "-mt-3 flex flex-col gap-4"}>
                  <div className={styles.progressSection}>
                    <div className={styles.persentageSection}>
                      <p className="text-center mt-4 text-base font-bold">Progess Pengisian Keseluruhan</p>
                      <div className={styles.persentage}>
                        <div className={styles.progressBar}>
                          <div
                            className={styles.insideProgress}
                    ...
                    {inProgressSheets.length > 0 && (
                      <Link href={`/sheets/${inProgressSheets[0].id}/summary`}>
                        <button type="button" className="font-bold text-xl">Lihat Hasil LKE Terkini</button>
                      </Link>
                    )}
                  </div>

                  <div className={`${styles.deadlineSection} flex`}>
                    <p className="text-center text-base font-bold">Deadline Pengisian LKE</p>
                    <div
                      className={`${styles.dateContainer} ${daysRemaining !== null && daysRemaining <= 10
                        ? "text-red-900 bg-red-200 border-red-900"
                        : "text-green-900 bg-green-200 border-green-900"
                  ...
                  <div className={styles.summarySection}>
                    <p className="text-center text-sm font-bold">Ringkasan Hasil Sementara</p>
                    <div className={styles.summaryScoreCard}>
                      <div className={styles.tempResult}>
                        <div className={styles.information}>
                          <div className={styles.scoreInfo}>
