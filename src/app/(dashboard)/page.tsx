    ...
    <div className={styles.mainContent}>
      ...
      <div className={styles.summaryCard}>
        ...
        <div className={styles.progressSection}>
          ...
          <Link href="#">
            <button type="button">Lihat Hasil LKE</button>
          </Link>
        </div>

        <div className={`${styles.deadlineSection} flex`}>
          <p>Deadline Pengisian LKE</p>
          <div className={`${styles.dateContainer} ${(daysRemaining !== null && daysRemaining <= 10) ? "text-red-900 bg-red-200 border-red-900" : "text-green-900 bg-green-200 border-green-900"}`}>
            <p>
              <svg
              ...
              >
                ...
                <path
                  ...
                  fill={(daysRemaining !== null && daysRemaining <= 10) ? "#7F1D1D" : "#14532D"}
                />
              </svg>{" "}
              {inProgressSheets.length > 0 ? (
                <span>
          ...
          <div className={`${styles.reminderContainer} ${(daysRemaining !== null && daysRemaining <= 10) ? "text-red-900" : "text-green-900"}`}>
            <p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="15"
              ...
              >
                ...
                <path
                  ...
                  fill={(daysRemaining !== null && daysRemaining <= 10) ? "#7F1D1D" : "#7F1D1D"}
                />
              </svg>{" "}
