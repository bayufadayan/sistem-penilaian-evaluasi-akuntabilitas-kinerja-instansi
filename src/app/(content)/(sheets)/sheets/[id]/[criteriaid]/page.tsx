        ...
        <div className={styles.fillCriteriaHeader}>
          ...
          <div className={styles.fillCriteriaHeroContainer}>
            <div className={styles.criteriaFilledProgress}>
              <small className="font-bold flex justify-between md:items-start items-end md:text-black text-blue-800">
          ...
          <div className={styles.criteriaContent}>
            <div className={`${styles.contentLeftMenu} `}>
              <div className="sticky top-24 transition-all duration-300 ease-in-out">
                ...
                <div
                  className={`${styles.criteriaListContainer} overflow-y-auto max-h-[60vh] rounded md:shadow-lg`}
                >
                      ...
                      .map((criterion) => (
                        <button
                          ...
                          className={`${selectedCriterion?.id === criterion.id
                            ...
                            : "hover:bg-blue-200 hover:text-blue-900 bg-white"
                            } ${styles.theCriteria
                        ...
                        >
                          <div
                            className={`${styles.criteriaNumber} ${selectedCriterion?.id === criterion.id
                              ? "md:bg-white md:text-blue-900 text-white"
                              : "md:bg-blue-900 md:text-white text-blue-900"
                              }`}
                          >
                  ...
                  <div className="flex">
                    <button
                      ...
                      className={`flex justify-center items-center gap-2 text-white font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none
                        ${isSaving ? "bg-gray-400 cursor-not-allowed" : "bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300"}`}
                      disabled={isSaving}
                    >
                      <FaArrowLeft /> Kembali
                    </button>
