    ...
    <footer>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.socialMedia}>
          <ul>
            {/* <!-- Youtube Icon --> */}
            <Link href={'https://www.youtube.com/channel/UCnxremt6hmTNxSYT1NbJOfw'} target="_blank">
              <svg
            ...
            {/* <!-- Facebook Icon --> */}
            <Link href={'https://www.facebook.com/bpmsph/'} target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            {/* <!-- Twitter Icon --> */}
            <Link href={'https://x.com/BPMSPH/'} target="_blank">
            ...
            {/* <!-- Instagram Icon --> */}
            <Link href={'https://www.instagram.com/bpmsph_ditjenpkh/'} target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            {/* <!-- Tiktok Icon --> */}
            <Link href={'https://www.tiktok.com/@bpmsphbogor'} target="_blank">
