...
export default function Navbar() {
  ...
  if (status === "loading") {
    return (
      <div className="flex items-center justify-center text-white bg-gradient-to-br from-purple-500 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 px-6 py-3 text-center me-2 mb-2 w-full font-bold">
        <svg
          aria-hidden="true"
          className="w-6 h-6 text-gray-200 animate-spin dark:text-gray-100 fill-blue-400 mr-3"
          viewBox="0 0 100 101"
          fill="none"
